...
w2v_path = "wikianswer.vectors.d300.bin"
...
part_epochs = [(9000, 2000, 1000), (100, 100, 100)]
...
import seq2seq_model_threebody as seq2seq_model
from seq2seq_model_threebody import WFPFKFEncoderRNN, DecoderRNN, MLPClassifier
...
if __name__ == "__main__":
	...
	train_pairs_class = train_pairs+test_pairs
	...
	for turbo in range(turbo_num):
		...
		for part in range(3):
			...
			for iter in range(1,epochs):
				...
				pairs_batch_ve = get_random_pairs(train_pairs_class, batch_size)
